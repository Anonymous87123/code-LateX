...
\caption{Diagram of mobile phone lithium battery} \label{fig1}
\end{figure}
...
\item {\bf Justification:} Our data is collected from official technical specifications from manufacturers like Apple, some other official web
sites and research papers, so it’s reasonable to assume the high quality of their data.
\item {\bf Assumption:} 
\item {\bf Justification:} 
\item {\bf Assumption:} 
\item {\bf Justification:} 
\end{itemize}
...
\midrule
$Q_{ref}$ & mAh & Typical capacity of modern flagship smartphones (approximately 14400 Coulombs) \\
$V_{nom}$ & V & Standard operating voltage platform for lithium-ion batteries \\
$V_{min}$ & V & Voltage at which the protection circuit cuts off the power (0\% State of Charge) \\
...
$h_{eff}$ & W/K & Effective heat transfer coefficient representing the phone's overall heat dissipation capability (estimated value) \\
