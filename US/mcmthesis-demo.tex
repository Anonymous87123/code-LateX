...
\mcmsetup{tstyle = \color{red}\bfseries,  % 修改题号，队号的颜色和加粗显示，黑色可以修改为 black
          tcn = 2616863, problem = E,     % 修改队号，参赛题号
...
\setlength{\parskip}{0pt}  % 覆盖类文件中的parskip设置，设为0消除一级标题间的额外间距

\tableofcontents
\vspace{-20pt}  % 负消类文件中的5ex间距，将"Contents"标题与目录内容间距缩为1ex
\endgroup
...
\subsubsection{Climate Change Impact}
Climate change has significantly altered weather patterns worldwide:
\begin{itemize}
    \item Increased frequency of extreme weather events
    \item Rising sea levels and coastal flooding
    \item More intense hurricanes and tropical storms
    \item Extended drought periods in certain regions
\end{itemize}

\subsubsection{Economic Consequences}
The economic impact is substantial. Extreme weather events are becoming more frequent due to climate change. As the economic
