...
\begin{example}{来自amare Donata Caesia}{}
    $x_1\ln x_1=x_2\ln x_2=-x_3\ln x_3,x_1<x_2<x_3$\\
    （1）证明$x_1+x_2+x_3>2$\\
    （2）证明$x_1+x_2>e(3-e)m^2+m+1$
\end{example}
\begin{solution}
设\[x_1\ln x_1=x_2\ln x_2=-x_3\ln x_3=m\]可以考虑加强证明\[x_1+x_2+x_3>-\frac{m^2}2-\frac13m+1+\frac{8}{3\e}+\frac{4\e}{135}\left(m+\frac1{\e}\right)^2\]
设$\varepsilon=m+\frac1{\e}$这是因为\[\begin{cases}x_1+x_2>1+m+\frac{m^2}2\\x_3>1-m-\frac{m^2}2\end{cases}\]
上界：\[x_1+x_2+x_3<2+(\e-3)m-\frac{m^2}{2}-\frac{2}{3}m^3\]

\end{solution}

\begin{example}{}{}
    $x_1\ln x_1=x_2\ln x_2=m$,，证明$x_1+x_2>1+m+\frac{m^2}2$.
\end{example}