...
2. Installing the ERMEnv Package

A. Change to the directory that contains the file setup.py and the subdirectory ERMEnv. 
...
3. Using the ERMEnv Package

The ERMEnv package is on your Python path. To import it into a Python script or session, 
execute:
