...
\small
\centering
\includegraphics[width=0.3\textwidth]{fig0.jpg}
...
$R_{int}$ & Ω & Internal resistance, increases sharply with decreasing temperature \\
...
$h_{eff}$ & W/K & Effective heat transfer coefficient representing overall heat dissipation capability \\
$\eta$ & dimensionless & Coulombic efficiency, decreases with aging or at low temperatures \\
\bottomrule
\end{tabular}
\vspace{2pt} % 稍微调整间距
