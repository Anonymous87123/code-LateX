...
\begin{enumerate}
\item 不要按题号从前往后顺着做。
\item 开局更适合先从第三十七题、第三十九题、第四十一题、第四十五题里挑最好定位的一题。
\item 第三十八题、第四十二题、第四十三题，默认更适合后做，等别题先帮它们缩小范围。
\item 相邻题通常不是原文里的就近题，反而中间隔一道题的组合更值得一起看。
\item 第四十四题一旦做出来，先看它能帮助判断哪些题。
\item 前百分之四十、前百分之五十、以及每个五分之一小区间里已经放了多少题，建议一直记着，以免把过多题目集中到同一区间。
\end{enumerate}
...
\phantomsection
\section*{第一章 先把这份报告看懂}
\addcontentsline{toc}{section}{第一章 先把这份报告看懂}


\phantomsection
\subsection*{1.1 这份报告到底在帮你解决什么}
\addcontentsline{toc}{subsection}{1.1 这份报告到底在帮你解决什么}
...
\begin{enumerate}
\item 先用较容易定位的题建立初始判断。
\item 一边做一边记录区间占用，防止某个区间放进太多题。
\item 一旦做出一道题，就立刻利用它去缩小别题搜索范围。
\item 最后再用段落字母偏向、已用段这些较弱线索来收尾。
\end{enumerate}


\phantomsection
\subsection*{1.2 样本口径只有一个}
\addcontentsline{toc}{subsection}{1.2 样本口径只有一个}
...
\phantomsection
\subsection*{1.3 “位置百分比”到底是什么意思}
\addcontentsline{toc}{subsection}{1.3 “位置百分比”到底是什么意思}
...
\begin{enumerate}
\item 如果一篇文章有 10 段，那么前百分之二十大致就是最前 2 段，百分之二十到百分之四十大致就是第 3 到第 4 段，最后百分之二十大致就是最后 2 段。
\item 如果一篇文章有 12 段，那么前百分之二十大致就是最前 2 到 3 段，百分之二十到百分之四十大致就是第 3 到第 5 段，最后百分之二十大致就是最后 2 到 3 段。
\end{enumerate}
...
\phantomsection
\subsection*{1.4 底层明细表和汇总表，实际都在记什么}
\addcontentsline{toc}{subsection}{1.4 底层明细表和汇总表，实际都在记什么}
...
\phantomsection
\subsection*{1.5 这 5 张图到底该怎么读}
\addcontentsline{toc}{subsection}{1.5 这 5 张图到底该怎么读}
...
\phantomsection
\subsubsection*{1.5.1 单题位置箱线图}
\addcontentsline{toc}{subsubsection}{1.5.1 单题位置箱线图}
...
\begin{enumerate}
\item 整体高不高。越高，说明越偏后；越低，说明越偏前。
\item 中间那个黑箱子短不短。短，说明这题分布更集中；长，说明这题分布更分散。
\item 两头尾巴长不长。尾巴越长，说明这题越可能出现在其他位置。
\end{enumerate}
...
\phantomsection
\subsubsection*{1.5.2 单题二成分带图}
\addcontentsline{toc}{subsubsection}{1.5.2 单题二成分带图}
...
\begin{enumerate}
\item 如果后段颜色最厚，动作就是先往后看，不要先在前面反复停留。
\item 如果前中段颜色连续更厚，动作就是先从前中段开始找，先看有没有和题干重复的关键词。
\item 如果前几块颜色差不多厚，动作就是先不要单独依赖这题判断，等别题来帮它缩范围。
\end{enumerate}
...
\phantomsection
\subsubsection*{1.5.3 单题一成热区图}
\addcontentsline{toc}{subsubsection}{1.5.3 单题一成热区图}
...
\begin{enumerate}
\item 如果一列里只有一个明显深色块，说明这题大多还是集中在一块地方。
\item 如果一列前后两头都深，中间反而不突出，说明这题经常前后都会去，这类题不适合只记一个平均位置。
\item 如果一列很多地方都差不多深，说明这题单独看时很难给出清楚方向，最好等别题先做出来。
\end{enumerate}
...
\phantomsection
\subsubsection*{1.5.4 题号对应段落字母分布图}
\addcontentsline{toc}{subsubsection}{1.5.4 题号对应段落字母分布图}
...
\phantomsection
\subsubsection*{1.5.5 段落字母反查题号图}
\addcontentsline{toc}{subsubsection}{1.5.5 段落字母反查题号图}
...
\phantomsection
\subsubsection*{1.5.6 这 5 张图到底按什么顺序看}
\addcontentsline{toc}{subsubsection}{1.5.6 这 5 张图到底按什么顺序看}
...
\begin{enumerate}
\item 先看二成分带图，决定先去前面、中间还是后面找。
\item 再看箱线图，判断这题适不适合早做。
\item 再看一成热区图，确认它会不会前后乱跑。
\item 最后才看两张字母图，只在收尾时用。
\end{enumerate}
...
\toprule
\textbf{图表} & \textbf{这张图在回答什么} & \textbf{你看完该立刻干什么} & \textbf{最容易看错的地方} \\
\midrule
\endfirsthead
\toprule
\textbf{图表} & \textbf{这张图在回答什么} & \textbf{你看完该立刻干什么} & \textbf{最容易看错的地方} \\
...
\phantomsection
\section*{第二章 单独看每一道题时，最该记住什么}
\addcontentsline{toc}{section}{第二章 单独看每一道题时，最该记住什么}


\phantomsection
\subsection*{2.1 十道题的大概落点}
\addcontentsline{toc}{subsection}{2.1 十道题的大概落点}
...
\toprule
\textbf{题号} & \textbf{第一眼先看哪里} & \textbf{第一眼没找到再看哪里} & \textbf{最容易误判什么} & \textbf{直接操作} \\
\midrule
\endfirsthead
\toprule
\textbf{题号} & \textbf{第一眼先看哪里} & \textbf{第一眼没找到再看哪里} & \textbf{最容易误判什么} & \textbf{直接操作} \\
...
\begin{enumerate}
\item 第三十六题、第三十九题、第四十四题，更像前中段题；第四十一题、第四十五题，更像后段题。
\item 第三十七题、第四十一题、第四十五题，最怕你只记一个平均位置，因为它们经常前后都会出现。
\item 第三十八题、第四十二题、第四十三题，自己更散，所以默认更适合晚一点处理。
\end{enumerate}
...
\phantomsection
\subsection*{2.2 谁适合先做，谁更适合后做}
\addcontentsline{toc}{subsection}{2.2 谁适合先做，谁更适合后做}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.230\linewidth}>{\raggedright\arraybackslash}p{0.230\linewidth}>{\raggedright\arraybackslash}p{0.230\linewidth}>{\raggedright\arraybackslash}p{0.230\linewidth}@{}}
\toprule
\textbf{题号} & \textbf{为什么可以先做或后做} & \textbf{更适合什么时候动它} & \textbf{做出来后较常帮助谁} \\
\midrule
\endfirsthead
\toprule
\textbf{题号} & \textbf{为什么可以先做或后做} & \textbf{更适合什么时候动它} & \textbf{做出来后较常帮助谁} \\
...
\phantomsection
\subsection*{2.3 容量账本为什么必须一直记}
\addcontentsline{toc}{subsection}{2.3 容量账本为什么必须一直记}
...
\toprule
\textbf{你现在已经记到的情况} & \textbf{这时该怎么做} & \textbf{为什么} \\
\midrule
\endfirsthead
\toprule
\textbf{你现在已经记到的情况} & \textbf{这时该怎么做} & \textbf{为什么} \\
...
\begin{enumerate}
\item 如果一篇文章有 10 段，那么“先看连续百分之四十篇幅”差不多就是先重点看连续 4 段。
\item 如果一篇文章有 12 段，那么差不多就是先重点看连续 5 段左右。
\end{enumerate}
...
\phantomsection
\section*{第三章 题和题之间，哪些关系可以直接用于做题}
\addcontentsline{toc}{section}{第三章 题和题之间，哪些关系可以直接用于做题}


\phantomsection
\subsection*{3.1 相邻题通常不是“就近题”}
\addcontentsline{toc}{subsection}{3.1 相邻题通常不是“就近题”}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}@{}}
\toprule
\textbf{相邻题} & \textbf{在原文里差不超过两段的比例} & \textbf{直接结论} \\
\midrule
\endfirsthead
\toprule
\textbf{相邻题} & \textbf{在原文里差不超过两段的比例} & \textbf{直接结论} \\
...
\phantomsection
\subsection*{3.2 更适合一起看的，是中间隔一道题的组合}
\addcontentsline{toc}{subsection}{3.2 更适合一起看的，是中间隔一道题的组合}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}@{}}
\toprule
\textbf{组合} & \textbf{在原文里差不超过两段的比例} & \textbf{直接结论} \\
\midrule
\endfirsthead
\toprule
\textbf{组合} & \textbf{在原文里差不超过两段的比例} & \textbf{直接结论} \\
...
\phantomsection
\subsection*{3.3 一题一旦做出来，下一题该往哪里找}
\addcontentsline{toc}{subsection}{3.3 一题一旦做出来，下一题该往哪里找}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.230\linewidth}>{\raggedright\arraybackslash}p{0.230\linewidth}>{\raggedright\arraybackslash}p{0.230\linewidth}>{\raggedright\arraybackslash}p{0.230\linewidth}@{}}
\toprule
\textbf{你已经知道的情况} & \textbf{下一题先看谁} & \textbf{下一题先在哪一块找} & \textbf{为什么可以参考这条规则} \\
\midrule
\endfirsthead
\toprule
\textbf{你已经知道的情况} & \textbf{下一题先看谁} & \textbf{下一题先在哪一块找} & \textbf{为什么可以参考这条规则} \\
...
\phantomsection
\subsection*{3.4 这一章可以先记什么}
\addcontentsline{toc}{subsection}{3.4 这一章可以先记什么}
...
\phantomsection
\section*{第四章 考场实战：从拿到题到做完题}
\addcontentsline{toc}{section}{第四章 考场实战：从拿到题到做完题}


\phantomsection
\subsection*{4.1 开做前 30 秒，先做什么}
\addcontentsline{toc}{subsection}{4.1 开做前 30 秒，先做什么}
...
\begin{enumerate}
\item 圈出最容易在原文里一眼认出来的东西，比如专有名词、数字、年份、百分比、引号、明显转折。
\item 粗看哪几题像定义句。最常见的信号，是题干里在解释“某个概念到底是什么意思”。
\item 粗看哪几题像总述或总结。最常见的信号，是题干在总括判断、收束全篇、概括前文。
\end{enumerate}


\phantomsection
\subsection*{4.2 第一轮怎么开局}
\addcontentsline{toc}{subsection}{4.2 第一轮怎么开局}
...
\begin{enumerate}
\item 如果文章前 1 到 3 段已经有明显观点、定义、案例、转折，那就先从第三十七题或第三十九题下手，先只看前段到中段里有没有和题干重复的关键词；有就停下来细看，没有就看下一段。
\item 如果文章前面大多只是背景和铺垫，真正信息明显在后面，那就先从第四十一题或第四十五题下手，先只看中后段和后段里有没有和题干重复的关键词；有就停下来细看，没有就继续往后。
\item 如果一时判断不出来，就先用第三十六题或第三十九题来试方向，因为它们相对更稳。
\item 如果某题自己很散，比如第三十八题、第四十二题、第四十三题，而你手里又没有别的线索，那就先放着。
\end{enumerate}
...
\begin{enumerate}
\item 最容易在原文里一眼认出来的题先做。
\item 如果都差不多，就先做更能帮你判断全文大方向的题。
\item 如果还差不多，就先做相对更稳的题。
\end{enumerate}


\phantomsection
\subsection*{4.3 每做出一题，都要记账}
\addcontentsline{toc}{subsection}{4.3 每做出一题，都要记账}


账本不用复杂，可以只记这 3 行：


前百分之四十等于 0，前百分之五十等于 0 五个小区间分别是：0 /\allowbreak{} 0 /\allowbreak{} 0 /\allowbreak{} 0 /\allowbreak{} 0 下一步先看：
...
\begin{enumerate}
\item 如果第三十七题落在前百分之二十，就记成：前百分之四十等于 1，前百分之五十等于 1，五个小区间分别是 1 /\allowbreak{} 0 /\allowbreak{} 0 /\allowbreak{} 0 /\allowbreak{} 0。
\item 如果第三十九题落在百分之二十到百分之四十，就记成：前百分之四十等于 2，前百分之五十等于 2，五个小区间分别是 1 /\allowbreak{} 1 /\allowbreak{} 0 /\allowbreak{} 0 /\allowbreak{} 0。
\end{enumerate}


\phantomsection
\subsection*{4.4 做出一题以后，下一步怎么机械推进}
\addcontentsline{toc}{subsection}{4.4 做出一题以后，下一步怎么机械推进}
...
\begin{enumerate}
\item 如果刚做出的是第三十九题，先去看第四十一题，先看后百分之四十；然后再看第四十四题，先看中段到中后段。
\item 如果刚做出的是第四十一题，先回头看第四十题和第四十二题，先看中段，不要在第四十一题附近硬找。
\item 如果刚做出的是第四十四题，下一步就先去看第四十五题、第四十一题、第四十三题、第四十二题。
\item 如果卡住的是第三十八题、第四十二题、第四十三题这种本来就散的题，就先放着，先去做能帮助它的题。
\end{enumerate}
...
\phantomsection
\subsection*{4.5 常用的决策卡}
\addcontentsline{toc}{subsection}{4.5 常用的决策卡}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}@{}}
\toprule
\textbf{如果已经发生了这件事} & \textbf{你下一步立刻做什么} & \textbf{如果这一带里有两个候选都像，怎么办} \\
\midrule
\endfirsthead
\toprule
\textbf{如果已经发生了这件事} & \textbf{你下一步立刻做什么} & \textbf{如果这一带里有两个候选都像，怎么办} \\
...
\phantomsection
\subsection*{4.6 最短执行版}
\addcontentsline{toc}{subsection}{4.6 最短执行版}
...
\begin{enumerate}
\item 先看题干，先挑最容易在原文里一眼认出来的题。
\item 开头已经有正文，就先看第三十七题或第三十九题；开头像铺垫，就先看第四十一题或第四十五题；看不出来，就用第三十六题或第三十九题先试方向。
\item 第三十八题、第四十二题、第四十三题默认后做，等别题先帮它们缩范围。
\item 每做出一题，都先记账，再问“它现在能帮到谁”。
\item 前百分之四十到 4 题、前百分之五十到 6 题、单个五分之一小区间到 3 题时，先提高警惕，不要再往同一区间继续集中。
\item 第三十九题很前时，第四十一题先往后找；第四十一题很后时，第四十题不要在附近找；第四十四题一出来，立刻去带第四十五题、第四十一题、第四十三题、第四十二题。
\item 已用段和字母只能往后放，不能直接判错。
\end{enumerate}
...
\phantomsection
\section*{第五章 这些规律的依据和使用边界}
\addcontentsline{toc}{section}{第五章 这些规律的依据和使用边界}


\phantomsection
\subsection*{5.1 主要证据}
\addcontentsline{toc}{subsection}{5.1 主要证据}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}>{\raggedright\arraybackslash}p{0.307\linewidth}@{}}
\toprule
\textbf{一套题在前后半篇怎么分} & \textbf{这样的卷子有多少套} & \textbf{大概占全部样本多少} \\
\midrule
\endfirsthead
\toprule
\textbf{一套题在前后半篇怎么分} & \textbf{这样的卷子有多少套} & \textbf{大概占全部样本多少} \\
...
\phantomsection
\subsection*{5.2 什么时候不要直接套用}
\addcontentsline{toc}{subsection}{5.2 什么时候不要直接套用}
...
\begin{enumerate}
\item 只出现过 8 到 12 次的规则，不要当绝对命令。
\item 第三十七题、第四十一题、第四十五题前后都可能出现，不要只记一个位置。
\item 这些统计主要是帮你缩范围，不是帮你直接锁答案。
\item 读不懂段意时，统计也不能替代原文判断。
\end{enumerate}


\phantomsection
\subsection*{5.3 最后只记这几句话}
\addcontentsline{toc}{subsection}{5.3 最后只记这几句话}
...
\begin{enumerate}
\item 不要按题号顺着做。
\item 先从最好定位的题开局，通常优先看第三十七题或第三十九题，或者第四十一题或第四十五题。
\item 第三十六题是帮你判断大方向的，第三十八题、第四十二题、第四十三题默认后做。
\item 相邻题通常不是就近题，更适合一起看的是中间隔一道题的组合。
\item 第三十九题很前时，第四十一题先往后找；第四十一题很后时，第四十题不要在附近找。
\item 第四十四题一旦做出来，先去看它能帮到谁。
\item 账本要一直记，已用段和字母只能收尾时参考，不能在开局时直接定答案。
\end{enumerate}
