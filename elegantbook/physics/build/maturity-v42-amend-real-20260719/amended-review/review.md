...
- 决策：`REWRITE`
- 来源字节：`2842:3019`
- 理由：把两类扫描结果在正文中的保留范围移到谓语后，保留区间判断、并列要求和不得升格硬边界的限制。
...
<pre>因此，粗扫和加密扫描的结果都应在正文中保留；结论仍应写成区间性的观测判断，不能把一个网格点直接升格为硬边界。</pre>
...
- 父 bundle：`4bed9ef2b569fb5061daa567882e2035f5c6e99a75350db8bee758a366c612ea`
- 父 manifest：`e9c3ad9409b45a459921549ae8e5435a4f0c272a7b40071f83ca648d66ae1a4f`
- 修订深度：`1`
- 本轮 hunk：`H003, H005`
