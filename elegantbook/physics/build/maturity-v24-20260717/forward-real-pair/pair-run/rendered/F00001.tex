...
\begin{solution}
这类题测的是长度，但求解先要确定“厚度沿长度方向怎样线性增长”：把劈尖的几何斜率写成 \(\alpha\approx D/L\)，再由条纹间距反求 \(\alpha\)。

空气劈尖取 \(n=1\)，且 \(30\) 条明纹跨越的是 \(29\) 个条纹间距，所以
\[
...
\approx \SI{0.0574}{mm}.
\]
细丝直径约为 \(\SI{5.74e-2}{mm}=\SI{57.4}{\micro m}\)，落在几十微米量级是合理的。计算时不能把 \(30\) 条条纹误当成 \(30\) 个间距，也不能漏掉空气层对应 \(n=1\)。
\end{solution}
