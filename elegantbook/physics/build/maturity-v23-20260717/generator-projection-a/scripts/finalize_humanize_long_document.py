    ...
    *,
    ...
    for binding, fragment in zip(bundle["unit_bindings"], bundle["fragments"]):
        ...
        try:
            ...
            fragment_gate_statuses[unit_id] = str(validation_payload["status"])
            ...
            if validation_payload["status"] != "PASS":
                errors.append(
                    f"{unit_id}:fragment_validator:{validation_payload['status']}"
                )
...
def _build_structural_semantic_review_request(
    *,
    ...
    if (
        ...
        or structural_plan_check.get("change_applied") is not True
...
def _finalize_locked(
    ...
    *,
    ...
    rewrites, transaction_bundles = collect_rewrites(rewrites_dir)
    ...
    for unit_id, bundle in rewrites.items():
        ...
        elif structural_plan_check.get("change_applied") is True:
            structural_plan_check["semantic_review_status"] = (
    ...
    if second_pass_receipt is not None and review_only_transaction_present:
        second_pass_evidence = {
            ...
            "filesystem_isolation_verified": False,
            "oracle_unreachable_verified": False,
            "error": "second_pass_receipt_not_allowed_for_review_only_structural_transaction",
        }
    ...
    structural_changes_applied = sum(
        ...
        and payload.get("change_applied") is True
    )
    ...
    if structural_semantic_review_blocks_delivery:
    ...
    if partial_regression:
        ...
        if _directory_hashes(publish_dir) == _directory_hashes(staging_dir):
            ...
            history = {
                ...
                "reason": (
                    "revised_structural_review_candidate"
