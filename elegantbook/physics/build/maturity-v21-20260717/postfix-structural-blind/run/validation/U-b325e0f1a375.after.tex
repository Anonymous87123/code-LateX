...
\begin{solution}
二胡弦两端固定，弦长必须容纳整数个半波长，即 \(l=n\dfrac{\lambda_n}{2}\)。结合边界条件与弦上波速公式，可得
 \(u=\sqrt{\frac{T}{\mu}},\qquad \lambda_n=\frac{2l}{n},\qquad f_n=\frac{u}{\lambda_n}=\frac{nu}{2l}.\) 
弦上的波速为 \(u=\sqrt{\dfrac{9.4}{3.8\times10^{-4}}}\approx \SI{157.3}{m/s}\)。基频对应 \(n=1\)：
...
也就是说，基频约为 \(\SI{262}{Hz}\)，各次谐频满足 \(f_n\approx 262n\ \si{Hz}\)。
\end{solution}
