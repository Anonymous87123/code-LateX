...
AUTHORING_SCHEMA = "humanize-short-patch-selection-authoring/v3"
...
AUTHORING_FIELDS = AUTHORING_FIELDS_V2 | {"focus_spans"}
SOURCE_FIELDS = {
    "sha256",
    "size_bytes",
    "encoding",
...
def finalize_scaffold(
    ...
    *,
    ...
    expected_inventory_hash = _inventory_hash(
        ...
        policy,
        findings,
        focus_spans=focus_spans if schema_version == AUTHORING_SCHEMA else None,
        span_suggestion_policy=suggestion_policy,
