...
\NewDocumentEnvironment{definition}{m m}{%
  ...
  \begin{tcolorbox}[
    ...
    enhanced,
    title={\thedefinition\ 定义\if\relax\detokenize{#1}\relax\else: #1\fi}
  ]%
  \phantomsection\addcontentsline{lod}{definitions}{%
    \thedefinition\hspace{1em}\if\relax\detokenize{#1}\relax 定义\else #1\fi}%
...
\NewDocumentEnvironment{theorem}{m m}{%
  ...
  \begin{tcolorbox}[
    ...
    attach boxed title to top left={yshift=-2mm,xshift=5mm},
    enhanced,
    title={\thetheorem\ 定理\if\relax\detokenize{#1}\relax\else: #1\fi}
  ]%
  \phantomsection\addcontentsline{loth}{theorems}{%
    \thetheorem\hspace{1em}\if\relax\detokenize{#1}\relax 定理\else #1\fi}%
  \label{thm:\thetheorem}%
}{%
  \end{tcolorbox}%
}
...
\NewDocumentEnvironment{example}{m m}{%
  ...
  \begin{tcolorbox}[
    ...
    attach boxed title to top left={yshift=-2mm,xshift=5mm},
    enhanced,
    title={\theexample\ 例题\if\relax\detokenize{#1}\relax\else: #1\fi}
  ]%
  \phantomsection\addcontentsline{loex}{examples}{%
    \theexample\hspace{1em}\if\relax\detokenize{#1}\relax 例题\else #1\fi}%
  \label{ex:\theexample}%
}{%
  \end{tcolorbox}%
}
...
\NewDocumentEnvironment{property}{m m}{%
  ...
  \begin{tcolorbox}[
    ...
    attach boxed title to top left={yshift=-2mm,xshift=5mm},
    enhanced,
    title={\theproperty\ 性质\if\relax\detokenize{#1}\relax\else: #1\fi}
  ]%
  \phantomsection\addcontentsline{lopr}{properties}{%
    \theproperty\hspace{1em}\if\relax\detokenize{#1}\relax 性质\else #1\fi}%
...
% 通用设置
\fancyhead[L]{\small\kt 离散数学} % 左边：书名（楷体）
...
\fancypagestyle{mainmatter}{
    \fancyhf{}
    \fancyhead[L]{\small\kt 离散数学}
    \fancyhead[C]{\small\st 计算机科学与工程学院~夏同}
