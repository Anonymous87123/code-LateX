...
$src = (Resolve-Path 'elegantbook2/试卷/2013级软件 工科数学分析下B.doc').Path
$dst = (Resolve-Path 'tmp/past-exams-docpdf').Path + '\2013-B.pdf'
$status = (Resolve-Path 'tmp/past-exams-docpdf').Path + '\2013-B.status.txt'
