...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{picture/16.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{picture/17.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Optuna：超参数优化
        \item DEAP：分布式进化算法
        \item TensorFlow/PyTorch：深度学习框架
    \end{itemize}
    ...
    \item \textbf{研究社区}：
    \begin{itemize}
        \item 国际会议：NeurIPS, ICML, ICLR
        \item 专门会议：GECCO, PPSN
        \item 期刊：TEVC, ECJ, JMLR
    \end{itemize}
\end{itemize}
...
\begin{enumerate}
    \item \textbf{打好基础}：深入理解传统优化算法
    \item \textbf{掌握工具}：熟练使用相关软件和框架
    \item \textbf{关注前沿}：跟踪最新研究进展
    \item \textbf{动手实践}：通过实验加深理解
    \item \textbf{跨学科学习}：结合优化、机器学习、理论计算机科学
\end{enumerate}
