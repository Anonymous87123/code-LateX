...
\usepackage{geometry}
\usepackage{fontspec}
\usepackage{amsmath, amsthm} % 注意：移除了 amsfonts 和 amssymb
\usepackage{bm}
\usepackage{enumitem}
\usepackage{graphicx}
\usepackage{array}
...
\newcommand{\vecc}[1]{\overrightarrow{#1}}  % 使用 unicode-math 的粗斜体命令
\newcommand{\dd}{\text{d}}
% ========================
% 1. 页面布局设置（窄边距）
\geometry{
...
% 通用设置
\fancyhead[L]{\small\kt 线性代数和解析几何作业} % 左边：书名（楷体）
...
\fancypagestyle{frontmatter}{
    \fancyhf{}
    \fancyhead[L]{\small\kt 线性代数和解析几何作业}
...
\fancypagestyle{tocmatter}{
    ...
    \fancyhead[R]{\small\st 夏同202530451676} 
    \fancyfoot[C]{\thepage}
...
\fancypagestyle{mainmatter}{
    \fancyhf{}
    \fancyhead[L]{\small\kt 线性代数和解析几何作业}
    \fancyhead[C]{\small\st 计类1班~夏同~202530451676}
