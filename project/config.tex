...
% 定理环境
\newtcbtheorem[use counter=theoremcounter]{theorem}{定理}{
  enhanced,  
...
% 引理环境
\newtcbtheorem[use counter=theoremcounter]{lemma}{引理}{
  enhanced,
  colback=Salmon!20,
...
% 例题环境
\newtcbtheorem[use counter=examplecounter]{example}{例题}{
  enhanced,
  colback=green!5,
