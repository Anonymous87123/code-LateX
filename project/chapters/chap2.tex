...
\begin{example}{}{}
    ...
    \begin{tabular}{@{}llll@{}}
        A.$14\leq T \leq 16$&B.$16 \leq T \leq 18$&C.$18\leq T \leq 20$&D.$20\leq T \leq 22$
    \end{tabular}
\end{example}
\begin{solution}
    出题背景是大名鼎鼎的Wallis公式：
...
所以：
    ...
    \end{align*}
则$T\approx\dfrac{(2n+1)\pi}{2}$，简单计算得知原题选B.
\newpage
方法二是使用放缩，先平方然后用糖水不等式：
\begin{align*}P^{2}&=\frac{2}{1}\cdot\frac{2}{1}\cdot\frac{4}{3}\cdot\frac{4}{3}\cdot\frac{6}{5}\cdot\frac{6}{5}\cdots\frac{200}{199}\cdot\frac{200}{199}\\&>\frac{2}{1}\cdot\frac{2}{1}\cdot\frac{4}{3}\cdot\frac{5}{4}\cdot\frac{6}{5}\cdot\frac{7}{6}\cdots\frac{200}{199}\cdot\frac{201}{200}\\&=268>16^2\end{align*}
\end{solution}
\begin{example}{}{}
